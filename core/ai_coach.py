...
"description": "Fetch the athlete's last N workout sessions.",
"input_schema": {
"type": "object",
"properties": {
"n": {"type": "integer"},
...
"description": (
"Get weekly training volume trend for a specific muscle group."
),
"input_schema": {
"type": "object",
"properties": {
    ...
    for name in exercise_names:
        ...
        if record:
            ...
            prs[name] = {
                ...
                "estimated_1rm": self._epley(record.get("weight_kg"), record.get("reps")),
            }
